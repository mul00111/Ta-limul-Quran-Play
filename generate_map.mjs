...
const customMatches = {
  ...
  "تنسون": { verse: "2:44", words: [6] }, // أََتَأْمُرُونَ النَّاسَ بِالْبِرِّ وَتَنسَوْنَ أَنفُسَكُمْ -> 6
  "ينصرون": { verse: "44:41", words: [10] }, // لا يغني مولى عن مولى شيئا ولا هم ينصرون -> 44:41 word 10
  ...
  "فصبر جميل": { verse: "12:18", words: [14, 15] }, // 12:18 or 12:83. Let's use 12:83:8,9
  ...
  "نوحا هدينا": { verse: "6:84", words: [7, 8] },
  ...
  "من شكر": { verse: "27:40", words: [30, 31] }, 
...
// Also I'll make sure to output the EXACT strings that are in server.ts so I can overwrite properly.
